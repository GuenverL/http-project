...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_sqlite', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony/db.db', 'user' => 'root', 'password' => NULL, 'path' => ($this->targetDirs[2].'/db.db'), 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\CV\\Bundle\\Entity'))), 'CV\\Bundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('CVBundle' => 'CV\\Bundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_fdc8b7c83c1c89ccd4639939c93d2cf309b6fadc32240b95c53c56982fae9948');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\CV\\Bundle/Resources/views'), 'CV');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_path' => ($this->targetDirs[2].'/db.db'),
            'database_driver' => 'pdo_sqlite',
            'database_host' => '127.0.0.1',
            'database_port' => NULL,
            'database_name' => 'symfony/db.db',
            'database_user' => 'root',
